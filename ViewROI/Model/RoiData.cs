...
namespace ViewWindow.Model
{
    public class RoiData
    {
        ...
        public RoiData(int id, Config.Rectangle1 rectangle1)
        {
            this._id = id;
            this._name = "Rectangle1";
        ...
        public RoiData(int id, Config.Rectangle2 rectangle2)
        {
            this._id = id;
            this._name = "Rectangle2";
        ...
        public RoiData(int id, Config.Circle circle)
        {
            this._id = id;
            this._name = "Circle";
            this._circle = circle;
